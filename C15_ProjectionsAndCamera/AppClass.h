...
class Application
{
	vector3 m_v3Position = vector3(0.0f, 0.0f, 5.0f); // of the camera
	vector3 m_v3Target = vector3(0.0f, 0.0f, 0.0f); // what we're looking at
	vector3 m_v3Upwards = vector3(0.0f, 1.0f, 0.0f); // which way is up
